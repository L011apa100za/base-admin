...
layui.use(['element', 'form', 'table', 'layer', 'laydate', 'tree', 'util'], function () {
    ...
    tableIns = table.render({
        ...
        , cols: [[
            ...
            , {field: 'userName', title: '传感器名称'}
            , {field: 'loginName', title: '所属模组'}
            , {field: 'valid', title: '是否允许后台检测', hide: true}
            , {field: 'limitMultiLogin', title: '是否允许多设备同时在线', hide: true}
            , {field: 'limitedIp', title: '限制允许登录的IP集合', hide: true}
            , {field: 'expiredTime', title: '设备更新时间', hide: true}
    ...
    tableInsOnLine = table.render({
        ...
        , cols: [[
            ...
            , {field: 'loginName', title: '传感器名称'}
            , {field: 'lastLoginTime', title: '最后工作时间'}
