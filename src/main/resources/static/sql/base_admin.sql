...
-- Records of sys_menu
-- ----------------------------
INSERT INTO `sys_menu` VALUES ('35cb950cebb04bb18bb1d8b742a02005', 'XXX菜单', '/xxx', '', 1, '2019-09-11 18:05:21', '2019-09-11 18:05:21');
...
INSERT INTO `sys_menu` VALUES ('35cb950cebb04bb18bb1d8b742a02xcc', '最大荷载', '/sys/sysMenu/menu', '35cb950cebb04bb18bb1d8b742a02xxx', 2, '2019-09-10 10:08:58', '2019-09-10 10:08:58');
...
INSERT INTO `sys_menu` VALUES ('78fb15a19e894777afbc239d574da423', 'yyy菜单', '', '', 2, '2020-10-16 13:04:41', '2020-10-16 13:04:41');
...
CREATE TABLE `sys_setting`  (
  ...
  `sys_check_pwd_encrypt` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '密码安全策略 Y/N',
...
-- ----------------------------
INSERT INTO `sys_setting` VALUES ('1', 'Base Admin', 'https://avatar.gitee.com/uploads/0/5137900_huanzi-qch.png!avatar100?1562729811', '© 2023 - 2024  氢链', '<h1 style=\"white-space: normal; text-align: center;\"><span style=\"color: rgb(255, 0, 0);\">通知</span></h1><p style=\"white-space: normal;\"><span style=\"color: rgb(255, 0, 0);\">1、你好；</span></p><p style=\"white-space: normal;\"><span style=\"color: rgb(255, 0, 0);\">2、xxxxxxx；</span></p><p><br/></p>', '2019-09-17 10:15:38', '2019-09-17 10:15:40', '123456', 'rgba(54, 123, 183,  0.73)', 'Y', 'N', 'Y');
...
INSERT INTO `sys_shortcut_menu` VALUES ('cf78ced9ce7b480c85fd2540d1936145', '阿里云', '/sys/sysAuthority/authority', '1', '104370a3fa7948bab156afd4a5f2a730', 1, '2019-09-12 18:35:39', '2020-12-31 14:44:23');
...
CREATE TABLE `sys_user`  (
  ...
  `expired_time` datetime NULL DEFAULT NULL COMMENT '设备更新时间，超过时间将不能登录系统',
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', 'sa', '超级管理员', 'E10ADC3949BA59ABBE56E057F20F883E', 'Y', '', NULL, '2019-09-17 12:00:36', '2019-09-17 12:00:36', 'Y', '2019-07-19 16:36:03', '2019-09-17 12:00:36');
INSERT INTO `sys_user` VALUES ('2', 'admin', '管理员', 'E10ADC3949BA59ABBE56E057F20F883E', 'Y', '', NULL, '2019-09-17 12:00:36', '2019-09-17 12:00:36', 'N', '2019-07-19 16:36:03', '2019-09-12 16:14:28');
...
CREATE TABLE `sys_file`  (
    `id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '表主键，附件id',
    ...
    `file_size` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '附件大小（MB）',
...
--氢气消耗量表 (hydrogen_consumption)
CREATE TABLE hydrogen_consumption (
    id INT AUTO_INCREMENT PRIMARY KEY,
    date DATE NOT NULL,
    actual_consumption INT NOT NULL,
    predicted_consumption INT NOT NULL
);
CREATE TABLE battery_life (
    id INT AUTO_INCREMENT PRIMARY KEY,
    date DATE NOT NULL,
    actual_life INT NOT NULL,
    predicted_life INT NOT NULL
);
INSERT INTO hydrogen_consumption (date, actual_consumption, predicted_consumption) VALUES
('2023-10-01', 120, 125),
('2023-10-02', 132, 130),
('2023-10-03', 101, 105),
('2023-10-04', 134, 135),
('2023-10-05', 90, 95);
INSERT INTO battery_life (date, actual_life, predicted_life) VALUES
('2023-10-01', 80, 79),
('2023-10-02', 78, 77),
('2023-10-03', 75, 74),
('2023-10-04', 73, 72),
